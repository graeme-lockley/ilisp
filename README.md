...
| Procedures that incure a state side effect have a `!` suffix | `set-variable-value!`, `pair-car!` |
...
Pairs and lists | `car`, `cdr`, `list-take`, `pair-car!`, `pair-cdr!`
