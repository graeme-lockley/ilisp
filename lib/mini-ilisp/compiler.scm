...
(const (compile-expression builder e)
    (if (TST.NullLiteral? e)
        ...
        (TST.IfThenElse? e)
            (do (const e1 (compile-expression (Builder.open-scope builder) (TST.IfThenElse-e1 e)))
                ...
                (const e2 (compile-expression (Builder.open-scope builder) (TST.IfThenElse-e2 e)))
                (Builder.br! builder merge-label)
            
                (Builder.label! builder else-label)
                (const e3 (compile-expression (Builder.open-scope builder) (TST.IfThenElse-e3 e)))
                (Builder.br! builder merge-label)
