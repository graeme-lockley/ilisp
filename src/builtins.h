...
extern Value *builtin_byte_vector_to_string_wrapped(Value *parameters, Value *env);
...
extern Value *builtin_exec_wrapped(Value *v, Value *env);
...
extern Value *builtin_read_string_wrapped(Value *parameters, Value *env);
extern Value *builtin_read_string_many_wrapped(Value *parameters, Value *env);
extern Value *builtin_socketp_wrapped(Value *parameters, Value *env);
extern Value *builtin_socket_close_wrapped(Value *parameters, Value *env);
extern Value *builtin_socket_listen_wrapped(Value *parameters, Value *env);
extern Value *builtin_socket_open_wrapped(Value *parameters, Value *env);
extern Value *builtin_socket_read_all_wrapped(Value *parameters, Value *env);
extern Value *builtin_socket_write_all_wrapped(Value *parameters, Value *env);
...
extern Value *builtin_string_map_wrapped(Value *parameters, Value *env);
...
extern Value *builtin_string_to_byte_vector_wrapped(Value *parameters, Value *env);
...
extern Value *builtin_threadp_wrapped(Value *parameters, Value *env);
...
extern Value *builtin_vector_nth_bang_wrapped(Value *parameters, Value *env);
extern Value *builtin_vector_range_wrapped(Value *parameters, Value *env);
extern Value *builtin_vector_reverse_wrapped(Value *parameters, Value *env);
extern Value *builtin_vector_slice_wrapped(Value *parameters, Value *env);
extern Value *builtin_vector_sort_bang_wrapped(Value *parameters, Value *env);
